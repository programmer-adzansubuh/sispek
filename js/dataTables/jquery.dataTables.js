...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<img src="../img/ic_search_black.png" height="25" style="margin-right: 3px;"></img><input type="search" style="border:none; box-shadow:none;" placeholder="Pencarian.." class="'+classes.sFilterInput+' inputs"/><div class="bar-only"></div>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": aktifkan untuk mengurutkan kolom yang turun",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Menamilkan _MENU_ baris",
